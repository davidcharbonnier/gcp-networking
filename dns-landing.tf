...
#  source     = "git@github.com:GoogleCloudPlatform/cloud-foundation-fabric.git//modules/dns?ref=v35.1.0"
...
module "landing-dns-policy-googleapis" {
  source     = "git@github.com:GoogleCloudPlatform/cloud-foundation-fabric.git//modules/dns-response-policy?ref=v35.1.0"
  project_id = module.landing-project.project_id
  name       = "googleapis"
  factories_config = {
